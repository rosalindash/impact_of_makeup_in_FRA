...
or
Download the weights from this link: (ArcFace Model:LResNet100E-IR,ArcFace@ms1m-refine-v2)
...
def extract_features(model, source, destination, weights=None):
    ...
    for image_name in source_list:
        ...
        if not image_path.lower().endswith('.jpg') and not image_path.lower().endswith('.png') \
